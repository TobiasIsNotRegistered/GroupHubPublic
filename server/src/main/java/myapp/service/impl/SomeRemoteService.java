...
public class SomeRemoteService implements SomeService,DTOMixin {
    ...
    String[] person_names = {"Neil Armstrong"  , "Michael Collins" , "Edwin Aldrin",      // Apollo 11
    ...
    public DTO loadEmptyTable(){

        id_table++;
        Random r = new Random();

        return new DTO( createSlot(TableAtt.ID, id_table, id_table),
                createSlot(TableAtt.ORGANIZER, Integer.toString(r.nextInt(21)), id_table),
                createSlot(TableAtt.DATE, "edit date here", id_table),
                createSlot(TableAtt.CREATION_DATE, "06.12.2017", id_table),
                createSlot(TableAtt.TITLE, "edit Title here", id_table),
                createSlot(TableAtt.DESCRIPTION, "edit descritpion here", id_table),
                createSlot(TableAtt.MAXSIZE, "edit maxSiz here", id_table),
                createSlot(TableAtt.MEETING_POINT, "edit MeetingPoint here", id_table),
                createSlot(TableAtt.DESTINATION_POINT, "edit DestinationPoint here", id_table));
    }
    ...
    public DTO loadNextTable() {
        ...
        return new DTO( createSlot(TableAtt.ID, id_table, id_table),
                        createSlot(TableAtt.ORGANIZER,r.nextInt(20), id_table),
    ...
    public DTO loadNextPerson(){
        ...
        return new DTO( createSlot(PersonAtt.ID, id_person, id_person),
                ...
                createSlot(PersonAtt.IS_USER, isUser, id_person),
                createSlot(PersonAtt.PASSWORD, password, id_person));
    }
